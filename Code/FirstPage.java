...
public class FirstPage extends JFrame implements ActionListener {
    ...
    public FirstPage() {
        ...
        backgroundImage = new ImageIcon(getClass().getResource("/Employee_Management/Images/bg.jpg"));

        // Load the logo image
        logoImage = new ImageIcon(getClass().getResource("/Employee_Management/Images/logo.png"));
